...
raw = pd.read_excel(file_path, sheet_name="Buses", header=None)
...
df = pd.read_excel(file_path, sheet_name="Buses", header=header_row)
...
# === Save results ===
output_file = "gravity_trade_model_actual_data_Ceil_results_Buses.xlsx"
